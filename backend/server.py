...
def _broadcast_html(message: str, button_text: str = "", button_url: str = "") -> str:
    ...
    if button_text and button_url:
        body += (
            ...
            f'background-color:#059669;background-image:linear-gradient(135deg,#10b981,#059669 60%,#047857);'
            f'color:#ffffff;text-decoration:none;padding:14px 30px;border-radius:10px;font-weight:700;'
            f'font-size:15px;box-shadow:0 4px 14px rgba(5,150,105,0.32);">'
            f'{button_text}</a></div>'
        )
...
STATIC_SITEMAP_PAGES = [
    ...
    {"loc": "https://mintslip.com/cease-and-desist-generator", "priority": "0.8", "changefreq": "weekly"},
    {"loc": "https://mintslip.com/cease-and-desist-letter", "priority": "0.9", "changefreq": "weekly"},
    {"loc": "https://mintslip.com/power-of-attorney-generator", "priority": "0.8", "changefreq": "weekly"},
    {"loc": "https://mintslip.com/durable-power-of-attorney", "priority": "0.9", "changefreq": "weekly"},
    {"loc": "https://mintslip.com/commercial-lease-generator", "priority": "0.8", "changefreq": "weekly"},
    {"loc": "https://mintslip.com/commercial-lease-agreement", "priority": "0.9", "changefreq": "weekly"},
