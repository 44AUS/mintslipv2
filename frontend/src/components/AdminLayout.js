      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate("/admin/overview")} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
              <img
                src={MintSlipLogo}
                alt="MintSlip"
            ...
            <p className="hidden sm:block text-sm text-slate-400">{adminInfo?.email}</p>
          </div>
