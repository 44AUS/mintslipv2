...
import { Plus, Trash2, ArrowLeft, Upload, X, Search, Building2, HelpCircle } from "lucide-react";
      ...
      <section className="bg-slate-50 border-t border-slate-200 py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600">Common questions about bank statements and our generator</p>
          </div>
          ...
          <Accordion type="single" collapsible className="space-y-3">
            <AccordionItem value="item-1" className="bg-white border border-slate-200 rounded-lg px-6">
              ...
              <AccordionContent className="text-slate-600 pb-4">
                A bank statement is a document issued by a bank that summarizes all account activity over a specific period, typically monthly. It shows deposits, withdrawals, transfers, fees, and the beginning and ending balances for your account.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-2" className="bg-white border border-slate-200 rounded-lg px-6">
              <AccordionTrigger className="text-left font-semibold text-slate-800 hover:text-green-700">
                What bank templates are available?
              </AccordionTrigger>
              <AccordionContent className="text-slate-600 pb-4">
                Our generator supports templates styled for major banks including Chase, Bank of America, Wells Fargo, Chime, and more. You can also create custom statements with your own branding by uploading a logo and customizing the layout.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3" className="bg-white border border-slate-200 rounded-lg px-6">
              ...
              <AccordionContent className="text-slate-600 pb-4">
                You can add individual transactions by clicking the "Add Transaction" button and entering the date, description, and amount (positive for deposits, negative for withdrawals). The system automatically calculates running balances based on your entries.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-4" className="bg-white border border-slate-200 rounded-lg px-6">
              <AccordionTrigger className="text-left font-semibold text-slate-800 hover:text-green-700">
                What's the difference between checking and savings statements?
              </AccordionTrigger>
              <AccordionContent className="text-slate-600 pb-4">
                Checking account statements typically show more frequent transactions like debit card purchases, checks, and ATM withdrawals. Savings account statements usually show fewer transactions and may include interest earned. Our generator supports both account types.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-5" className="bg-white border border-slate-200 rounded-lg px-6">
              <AccordionTrigger className="text-left font-semibold text-slate-800 hover:text-green-700">
                Can I upload my own bank logo?
              </AccordionTrigger>
              <AccordionContent className="text-slate-600 pb-4">
                Yes! You can upload a custom logo for any bank or financial institution. Simply click the upload area and select your logo image. Supported formats include PNG, JPG, and SVG for best quality.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-6" className="bg-white border border-slate-200 rounded-lg px-6">
              ...
              <AccordionContent className="text-slate-600 pb-4">
                Our system automatically calculates running balances based on your starting balance and each transaction. Deposits increase the balance, while withdrawals decrease it. The ending balance reflects all transactions during the statement period.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-7" className="bg-white border border-slate-200 rounded-lg px-6">
              <AccordionTrigger className="text-left font-semibold text-slate-800 hover:text-green-700">
                Can I generate statements for previous months?
              </AccordionTrigger>
              <AccordionContent className="text-slate-600 pb-4">
                Yes! You can set any date range for your statement. Simply select the statement start and end dates to generate statements for any time period you need, whether current or historical.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-8" className="bg-white border border-slate-200 rounded-lg px-6">
              ...
              <AccordionContent className="text-slate-600 pb-4">
                Absolutely! All information is processed directly in your browser. We do not store your account numbers, balances, or any transaction data on our servers. Your financial information stays completely private on your device.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
