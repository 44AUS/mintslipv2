                ...
                {selectedTemplate === 'template-c' && formData.workerType === 'employee' && (
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Federal and provincial tax withholding details (Workday template only)
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        <Label className="text-xs text-slate-600">Provincial Additional Withholding</Label>
                        <Input
                          type="number"
                          value={formData.provincialAdditionalWithholding}
                          onChange={(e) => setFormData({...formData, provincialAdditionalWithholding: e.target.value})}
                          placeholder="0"
                          className="h-9"
                          min="0"
                          step="0.01"
