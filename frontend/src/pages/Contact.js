  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta name="description" content="Contact MintSlip for support with paystubs, tax forms, or any document questions. Our team responds within 24 hours. Located in Atlanta, Georgia, USA." />
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div className="bg-gradient-to-br from-green-800 to-green-900 text-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#0088cc]/50 flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-blue-200" viewBox="0 0 24 24" fill="currentColor">
