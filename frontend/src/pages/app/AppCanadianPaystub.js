...
import {
  ...
  IonBadge, IonModal, IonPage, IonHeader, IonToolbar, IonTitle, IonButtons, IonContent,
} from "@ionic/react";
      ...
      <div style={{ height: "100%", overflowY: "auto", padding: "16px" }}>
        <div style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: "var(--ion-color-medium)", marginTop: 4, fontSize: "0.875rem" }}>
            Select a template to generate Canadian pay stubs with CPP, EI, and provincial tax calculations.
          </p>
        </div>
        ...
        <IonPage>
          <IonHeader>
            <IonToolbar>
              ...
              <IonTitle style={{ color: "#fff", fontSize: "1rem", fontWeight: 700 }}>Canadian Pay Stub Details</IonTitle>
              <IonButtons slot="end">
