...
const FIELD_POSITIONS = {
  ...
  box1: { x: 310, y: 728, fontSize: 9 },
  box2: { x: 310, y: 692, fontSize: 9 },
  box3: { x: 310, y: 668, fontSize: 9 },
  box5: { x: 310, y: 620, fontSize: 9 },
  box7: { x: 310, y: 578, fontSize: 10 },
  box9: { x: 310, y: 548, fontSize: 9 },
  box11: { x: 310, y: 512, fontSize: 9 },
  box4: { x: 410, y: 668, fontSize: 9 },
  box6: { x: 410, y: 620, fontSize: 9 },
  box8: { x: 410, y: 584, fontSize: 9 },
  box10: { x: 410, y: 548, fontSize: 9 },
  box12: { x: 410, y: 512, fontSize: 9 },
  box15: { x: 410, y: 476, fontSize: 9 },
