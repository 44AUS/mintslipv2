...
export async function generateBankTemplateC(doc, data, pageWidth, pageHeight, margin) {
  ...
  doc.setFontSize(9);
  doc.setFont("helvetica", "bold");
  doc.text("Total Deposits and Additions", contentMargin + 5, y);
  doc.text(`$${totalDeposits.toLocaleString(undefined, { minimumFractionDigits: 2 })}`, pageWidth - rightContentMargin - 5, y, { align: "right" });
