...
export function generateTemplateH(doc, data, pageWidth, pageHeight, margin) {
  ...
  // Gross Wages Total - white background, gray borders (no top border)
  doc.setFillColor(...colors.white);
  doc.rect(col1X, totalsY, col1Width, rowHeight + 2, 'F');
  doc.setDrawColor(...colors.borderGray);
  // Draw only left, right, bottom borders (no top)
  doc.line(col1X, totalsY, col1X, totalsY + rowHeight + 2); // Left
  doc.line(col1X + col1Width, totalsY, col1X + col1Width, totalsY + rowHeight + 2); // Right
  doc.line(col1X, totalsY + rowHeight + 2, col1X + col1Width, totalsY + rowHeight + 2); // Bottom
  ...
  // Withholding Total - white background, gray borders (no top border)
  doc.setFillColor(...colors.white);
  doc.rect(col2X, totalsY, col2Width, rowHeight + 2, 'F');
  // Draw only left, right, bottom borders (no top)
  doc.line(col2X, totalsY, col2X, totalsY + rowHeight + 2); // Left
  doc.line(col2X + col2Width, totalsY, col2X + col2Width, totalsY + rowHeight + 2); // Right
  doc.line(col2X, totalsY + rowHeight + 2, col2X + col2Width, totalsY + rowHeight + 2); // Bottom
  ...
  // Deductions Total - white background, gray borders (no top border)
  doc.setFillColor(...colors.white);
  doc.rect(col3X, totalsY, col3Width, rowHeight + 2, 'F');
  // Draw only left, right, bottom borders (no top)
  doc.line(col3X, totalsY, col3X, totalsY + rowHeight + 2); // Left
  doc.line(col3X + col3Width, totalsY, col3X + col3Width, totalsY + rowHeight + 2); // Right
  doc.line(col3X, totalsY + rowHeight + 2, col3X + col3Width, totalsY + rowHeight + 2); // Bottom
