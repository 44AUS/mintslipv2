...
const FIELD_POSITIONS_2024 = {
  name: { x: 65, y: 665, fontSize: 11 },
  businessName: { x: 65, y: 640, fontSize: 10 },
  individual: { x: 73, y: 604, fontSize: 10 },
  ccorp: { x: 182, y: 604, fontSize: 10 },
  scorp: { x: 254, y: 604, fontSize: 10 },
  partnership: { x: 326, y: 604, fontSize: 10 },
  trust: { x: 390, y: 604, fontSize: 10 },
  llc: { x: 73, y: 590, fontSize: 10 },
  llcCode: { x: 425, y: 592, fontSize: 10 },
  other: { x: 73, y: 554, fontSize: 10 },
  otherText: { x: 165, y: 554, fontSize: 9 },
  exemptPayeeCode: { x: 555, y: 590, fontSize: 9 },
  fatcaCode: { x: 530, y: 555, fontSize: 9 },
